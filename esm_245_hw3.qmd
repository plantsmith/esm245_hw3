...
# Calculate the average willingness to pay by finding the area under the curve
...
# represents the base of the triange (where the slope hits 0)
base_premium <- -intercept / slope

# Calculate the area of the triangle for average willingness to pay
